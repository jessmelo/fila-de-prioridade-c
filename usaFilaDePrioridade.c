...
int main() {
  ...
  printf("\n\nConsultando prioridade\n");

  float priori;
  if(consultarPrioridade(f, 5, &priori)) printf("Prioridade de 5 é: %f \n", priori);
  else printf("Funcao retornou false kk\n");
  if(consultarPrioridade(f, 3, &priori)) printf("Prioridade de 3 é: %f \n", priori);
  else printf("Funcao retornou false kk\n");
  if(consultarPrioridade(f, 14, &priori)) printf("Prioridade de 14 é: %f \n", priori);
  else printf("Funcao retornou false kk\n");
  if(consultarPrioridade(f, 2, &priori)) printf("Prioridade de 2 é: %f \n", priori);
  else printf("Funcao retornou false kk\n");
  if(consultarPrioridade(f, 15, &priori)) printf("Prioridade de 15 é: %f \n", priori);
  else printf("Funcao retornou false kk\n");
  if(consultarPrioridade(f, 0, &priori)) printf("Prioridade de 0 é: %f \n", priori);
  else printf("Funcao retornou false kk\n");
